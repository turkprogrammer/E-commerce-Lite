 ...
 */
final class Version20260312145624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Добавляем колонки с NULL значением
        $this->addSql('ALTER TABLE orders ADD COLUMN created_at DATETIME');
        $this->addSql('ALTER TABLE orders ADD COLUMN updated_at DATETIME');
        
        // Обновляем существующие записи текущим временем
        $this->addSql("UPDATE orders SET created_at = datetime('now'), updated_at = datetime('now') WHERE created_at IS NULL");
    }
